export default {
  ...
  theme_dark: 'ダーク',
  theme_system: 'システム',
  island_style: 'ダイナミックアイランドの様式',
  island_style_desc: 'デスクトップ版限定、モバイル版にはこの設定はありません。',
  island_style_original: '従来型',
  island_style_edge_dock: 'エッジドック',
  island_size: 'つまみのサイズ',
  island_size_sm: '小',
  island_size_md: '中',
  island_size_lg: '大',
