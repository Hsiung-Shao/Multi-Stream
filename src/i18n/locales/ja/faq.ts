const faq = {
    ...
    'items.youtube_search.content': 'ダイナミックアイランドの YouTube チャンネル検索は、サイトに収録済みのチャンネル名簿と名前を照合するもので、YouTube 全体をリアルタイムに検索するわけではありません。検索できない場合は、そのチャンネルがまだサイトに収録されていないことがほとんどです。また、該当した YouTube チャンネルは、Twitch チャンネルのように即座にプレビュー・再生されるのではなく、お気に入りに追加されます。名簿にそのチャンネルの現在の配信 URL が含まれていないためです。チャンネルが配信を開始したら、お気に入りから読み込んで視聴してください。',
