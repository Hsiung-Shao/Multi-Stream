const common = {
  ...
  'landing.hero_subtitle': 'Esports multi-POV, VTuber collabs — Twitch and YouTube streams on one screen.',
  ...
  'landing.hero_brief': 'Free · No sign-up · Up to 16 streams at once · Per-stream volume & multi-chat',
  'landing.what_title': 'What is MultiStream Hub?',
