const common = {
  ...
  'common.share_canvas': 'Share canvas',
  'common.share_copied': 'Link copied — send it to a friend',
  'common.share_empty': 'Add at least one stream before sharing',
  'common.share_failed': "Couldn't copy — please copy the URL manually",
  ...
  'empty_state.headline': 'Watch Multiple Streams at Once',
  'empty_state.intro': 'MultiStream Hub lets you watch multiple Twitch and YouTube live streams on one screen, with integrated chat and flexible layouts — completely free, no account required. Paste a URL or channel name to start.',
  'quick_add.label': 'Add a live stream',
  'quick_add.placeholder': 'Paste a Twitch / YouTube stream URL or channel name',
  ...
  'landing.hero_definition': 'MultiStream Hub is a free, browser-based multi-stream viewer that lets you watch up to 16 Twitch and YouTube live streams at the same time on a single screen, with no account or download required. Add streams by pasting a channel URL or searching for a streamer, then arrange them with automatic grid layouts or drag, resize, and pin each window freely in canvas mode. Built-in chat integration displays multiple Twitch and YouTube chat rooms alongside the video players, while independent volume controls let you focus on one voice without losing sight of any stream. A favorites system with live-status detection, five interface languages (Traditional Chinese, English, Japanese, Korean, and Simplified Chinese), and support for desktop and mobile browsers make it a practical dashboard for esports tournaments, VTuber collabs, and multi-channel events.',
