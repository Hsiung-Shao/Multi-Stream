const common = {
  ...
  'landing.hero_subtitle': 'e스포츠 다중 시점, 버튜버 합방 — Twitch와 YouTube 방송을 한 화면에서.',
  ...
  'landing.hero_brief': '무료 · 가입 불필요 · 최대 16개 동시 시청 · 방송별 음량과 다중 채팅',
  'landing.what_title': 'MultiStream Hub란?',
