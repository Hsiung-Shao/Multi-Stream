const common = {
  ...
  'common.share_canvas': '分享畫布',
  'common.share_copied': '連結已複製，貼給朋友就能一起看',
  'common.share_empty': '先加入至少一個直播再分享',
  'common.share_failed': "複製失敗，請手動複製網址",
  ...
  'empty_state.headline': '同時觀看多個直播',
  'empty_state.intro': 'MultiStream Hub 讓你在同一個畫面同時觀看多個 Twitch 與 YouTube 直播，支援聊天室整合與自由佈局，完全免費、無需註冊。貼上網址或頻道名稱即可開始。',
  'quick_add.label': '新增直播串流',
  'quick_add.placeholder': '貼上 Twitch / YouTube 直播網址或頻道名稱',
  'quick_add.button': '開始觀看',
  'quick_add.error_generic': '無法新增串流，請確認網址或頻道名稱',
  ...
  'landing.footer.nav': '網站導覽',
  'landing.hero_screenshot_alt': 'MultiStream Hub 畫布同時播放三個直播視窗與聊天室',
  // Hotkeys
  'hotkeys.title': '鍵盤快捷鍵',
