...
export default {
    ...
    'instructions.canvas.description': '認識 MultiStream Hub 的畫布工作區：自動排版、拖曳把手與四角縮放、拖到另一個視窗上互換，以及放大時鄰居自動讓位、關閉後空白自動填補。',
    ...
    'instructions.settings.title': '設定與播放行為：主題、動態島樣式、資料備份 - MultiStream Hub',
    'instructions.settings.description': '調整 MultiStream Hub 的主題與語言、動態島樣式、新串流自動靜音與背景開台偵測，並把收藏與布局備份到檔案。',
    'instructions.share.title': '分享畫布：把多直播組合變成一條連結 - MultiStream Hub',
