...
export const DynamicIsland = () => {
    ...
    return (
        ...
        >
            <div
                ref={nodeRef}
                className="fixed z-50 bottom-8 left-1/2 -translate-x-1/2 bg-black/80 backdrop-blur-md rounded-full px-4 py-2 flex items-center gap-2 border border-white/10 shadow-2xl transition-all hover:scale-105 active:scale-95 cursor-move"
            ...
            >
                <div className="flex items-center gap-1 on-drag-cancel cursor-auto" onMouseDown={(e) => e.stopPropagation()}>
                    ...
                    <Button
                        ...
                        size="icon"
                        className="rounded-full hover:bg-white/10 text-white"
                        onClick={() => { /* TODO: Open Add Window Dialog */ }}
                        title="新增視窗"
                    >
                        <Plus size={20} />
                    </Button>
