...
//       userSettings: parse(localStorage.getItem('userSettings'), null),
//       favoriteStreams: parse(localStorage.getItem('favoriteStreams'), []),
//       favoriteCategories: parse(localStorage.getItem('favoriteCategories'), []),
//       controlPanelCollapsed: localStorage.getItem('controlPanelCollapsed'),
//       multiStreamLayout: parse(localStorage.getItem('multiStreamLayout'), null),
//       adConfig: parse(localStorage.getItem('adConfig'), null)
//     };
//     return data;
//   },
// 
...
// 收藏分類管理
/* [MIGRATED] favoriteCategories moved to src/features/favorites/CategoryRepository.ts */

// 收藏串流管理
/* [MIGRATED] favoriteStreams moved to src/features/favorites/* */
...
function showFavoriteStreamsManager() {
  ...
  if (filteredList.length === 0) {
    ...
    filteredList.forEach((item) => {
      ...
      const safeItemUrl = escape(item.url);
...
// 全選收藏
/* [MIGRATED] Legacy UI functions (Selection, Loading, Live Status, Add Current) moved/obsolete */
/*
// [MIGRATED] START BLOCK A
...
// 
// /* [MIGRATED] youtubeApiUtils moved to src/utils/youtubeApi.ts */
// 
// // 批量更新收藏頻道的開台狀態
...
// 收藏管理搜尋功能
/* [MIGRATED] Legacy Search UI moved/obsolete */
/*
