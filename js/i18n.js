...
const i18n = {
  ...
  translations: {
    'zh-TW': {
      ...
      'youtubeLiveStatusStep1': '在收藏管理中添加 YouTube 直播網址（目前僅支援正在直播網址，例如：https://www.youtube.com/watch?v=VIDEO_ID）',
      ...
      'youtubeLiveStatusTip': '💡 提示：YouTube 收藏功能目前僅支援輸入直播網址，新增後會自動監測頻道開台狀態。當頻道正在直播時，可直接從收藏清單中選擇加入串流',
      'backupTitle': '💾 數據備份',
    ...
    'zh-CN': {
      ...
      'youtubeLiveStatusStep1': '在收藏管理中添加 YouTube 直播网址（目前仅支援正在直播网址，例如：https://www.youtube.com/watch?v=VIDEO_ID）',
      ...
      'youtubeLiveStatusTip': '💡 提示：YouTube 收藏功能目前仅支援输入直播网址，新增后会自动监测频道开台状态。当频道正在直播时，可直接从收藏清单中选择加入串流',
      'backupTitle': '💾 数据备份',
    ...
    'en': {
      ...
      'youtubeLiveStatusStep1': 'Add YouTube live stream URL to favorites (currently only supports live stream URLs, e.g., https://www.youtube.com/watch?v=VIDEO_ID)',
      ...
      'youtubeLiveStatusTip': '💡 Tip: YouTube favorites currently only support adding live stream URLs. After adding, the system will automatically monitor the channel\'s live status. When a channel is live, you can directly select it from the favorites list to add to streams',
    ...
    'ja': {
      ...
      'youtubeLiveStatusStep1': 'お気に入り管理に YouTube ライブストリーム URL を追加します（現在、ライブストリーム URL のみサポート、例：https://www.youtube.com/watch?v=VIDEO_ID）',
      ...
      'youtubeLiveStatusTip': '💡 ヒント：YouTube お気に入り機能は現在、ライブストリーム URL の入力のみサポートしています。追加後、システムは自動的にチャンネルのライブステータスを監視します。チャンネルがライブ中の場合、お気に入りリストから直接選択してストリームに追加できます',
    ...
    'youtubeLiveStatusStep1': '즐겨찾기 관리에 YouTube 라이브 스트림 URL을 추가합니다(현재 라이브 스트림 URL만 지원, 예: https://www.youtube.com/watch?v=VIDEO_ID)',
    ...
    'youtubeLiveStatusTip': '💡 팁: YouTube 즐겨찾기 기능은 현재 라이브 스트림 URL 입력만 지원합니다. 추가 후 시스템은 자동으로 채널의 라이브 상태를 모니터링합니다. 채널이 라이브 중일 때 즐겨찾기 목록에서 직접 선택하여 스트림에 추가할 수 있습니다',
    'backupTitle': '💾 데이터 백업',
