...
const i18n = {
  ...
  translations: {
    ...
    'aboutFeature10Desc': '즐겨찾기 Twitch 채널의 라이브 상태를 자동으로 감지하고 표시합니다',
    ...
    'liveStatusStep1': '즐겨찾기 Twitch 채널은 자동으로 라이브 상태를 표시합니다',
    'liveStatusStep2': '녹색 점(🟢)은 채널이 라이브 중임을 나타내며, 시청자 수가 표시됩니다',
    'liveStatusStep3': '회색 점(⚫)은 채널이 오프라인임을 나타냅니다',
    'liveStatusStep4': '라이브 상태는 자동으로 정기적으로 업데이트됩니다(기본값은 5분마다)',
    'liveStatusTip': '💡 팁: 라이브 중인 채널은 자동으로 목록의 맨 앞으로 정렬되어 빠르게 찾을 수 있습니다',
    'backupTitle': '💾 데이터 백업',
