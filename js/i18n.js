...
const i18n = {
  ...
  translations: {
    'zh-TW': {
      ...
      'consentDescription': '我們使用 Google Analytics 來分析網站流量，並可能顯示 Google AdSense 廣告。您可以選擇接受或拒絕這些服務。詳細資訊請參閱我們的',
      ...
      'aboutTerms4': '本工具使用 YouTube API 和 Twitch API 來提供搜尋和開台狀態查詢功能。使用本工具即表示您同意遵守 YouTube API 服務條款和 Twitch API 服務條款。',
      'aboutTerms5': '免責聲明：本工具僅作為觀看工具使用，不會儲存、重製或修改任何直播內容。所有直播內容均由各平台和創作者提供，本工具不對直播內容的合法性、準確性或可用性負責。使用者應自行承擔使用本工具的風險。',
      'aboutTerms6': '詳細的服務條款請參閱服務條款頁面。',
      'termsOfService': '服務條款',
    ...
    'zh-CN': {
      ...
      'consentDescription': '我们使用 Google Analytics 来分析网站流量，并可能显示 Google AdSense 广告。您可以选择接受或拒绝这些服务。详细信息请参阅我们的',
      'consentAnalytics': '分析（Google Analytics）',
      ...
      'aboutTerms4': '本工具使用 YouTube API 和 Twitch API 来提供搜寻和开台状态查询功能。使用本工具即表示您同意遵守 YouTube API 服务条款和 Twitch API 服务条款。',
      'aboutTerms5': '免责声明：本工具仅作为观看工具使用，不会储存、重制或修改任何直播内容。所有直播内容均由各平台和创作者提供，本工具不对直播内容的合法性、准确性或可用性负责。使用者应自行承担使用本工具的风险。',
      'aboutTerms6': '详细的服务条款请参阅服务条款页面。',
      'termsOfService': '服务条款',
      ...
      'version1.6.2.change3': '新增收藏串流清单刷新工具 (针对Twitch频道使用)',
    ...
    'en': {
      ...
      'consentDescription': 'We use Google Analytics to analyze website traffic and may display Google AdSense ads. You can choose to accept or reject these services. For more information, please see our',
      ...
      'version1.6.2.change3': 'Added favorite streams list refresh tool (for Twitch channels)',
    ...
    'ja': {
      ...
      'consentDescription': '当サイトでは、Google Analytics を使用してウェブサイトのトラフィックを分析し、Google AdSense 広告を表示する場合があります。これらのサービスを受け入れるか拒否するかを選択できます。詳細については、',
      'consentAnalytics': '分析（Google Analytics）',
      ...
      'aboutTerms4': 'このツールは、検索とライブステータス照会機能を提供するために YouTube API と Twitch API を使用します。このツールを使用することにより、YouTube API サービス規約および Twitch API サービス規約に準拠することに同意したものとみなされます。',
      'aboutTerms5': '免責事項：このツールは視聴ツールとしてのみ使用され、ライブストリーミングコンテンツを保存、複製、または変更することはありません。すべてのライブストリーミングコンテンツは、それぞれのプラットフォームとクリエイターによって提供されます。このツールは、ライブストリーミングコンテンツの合法性、正確性、または可用性について責任を負いません。ユーザーは、このツールを使用するリスクを自己負担するものとします。',
      'aboutTerms6': '詳細な利用規約については、利用規約ページを参照してください。',
      'termsOfService': '利用規約',
      ...
      'version1.6.2.change3': 'お気に入りストリームリストのリフレッシュツールを追加（Twitch チャンネル用）',
    ...
    'ko': {
      ...
      'consentDescription': '당사는 Google Analytics를 사용하여 웹사이트 트래픽을 분석하고 Google AdSense 광고를 표시할 수 있습니다. 이러한 서비스를 수락하거나 거부할 수 있습니다. 자세한 내용은',
    ...
    'version1.6.2.change3': '즐겨찾기 스트림 목록 새로고침 도구 추가 (Twitch 채널용)',
